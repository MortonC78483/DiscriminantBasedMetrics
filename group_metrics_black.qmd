...
plot <- data.frame(auc = aucs, pmse = pmses, specks = speckss, synth_type = synth_type, pov_class = pov_class)
...
```{r}
# perm_auc_good = permutation_sig(data_mi, synth_good, "pov", add_discriminator_auc, 50, calc_disc, "discriminator_auc")
# perm_auc_med = permutation_sig(data_mi, synth_med, "pov", add_discriminator_auc, 50, calc_disc, "discriminator_auc")
# perm_auc_bad = permutation_sig(data_mi, synth_bad, "pov", add_discriminator_auc, 50, calc_disc, "discriminator_auc")
# 
# perm_pmse_good = permutation_sig(data_mi, synth_good, "pov", add_pmse, 50, calc_disc, "pmse")
# perm_pmse_med = permutation_sig(data_mi, synth_med, "pov", add_pmse, 50, calc_disc, "pmse")
# perm_pmse_bad = permutation_sig(data_mi, synth_bad, "pov", add_pmse, 50, calc_disc, "pmse")
# 
# perm_specks_good = permutation_sig(data_mi, synth_good, "pov", add_specks, 50, calc_disc, "specks")
# perm_specks_med = permutation_sig(data_mi, synth_med, "pov", add_specks, 50, calc_disc, "specks")
# perm_specks_bad = permutation_sig(data_mi, synth_bad, "pov", add_specks, 50, calc_disc, "specks")
```
...
#       perm_specks_good, perm_specks_med, perm_specks_bad), "../paper_scripts/perm.csv")

perm_test = read.csv("../paper_scripts/perm_50.csv")
