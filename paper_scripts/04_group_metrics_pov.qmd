...
colnames(one_model_df) <- c("aucs", "speckss", "pmses", "pmse_ratios", "synth_type", "pov_class")

two_model_df <- data.frame(matrix(ncol = 6, nrow = 0))
colnames(two_model_df) <- c("aucs", "speckss", "pmses", "pmse_ratios", "synth_type", "pov_class")
```
