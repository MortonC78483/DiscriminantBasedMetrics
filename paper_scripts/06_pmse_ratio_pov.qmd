...
Save results
```{r}
write_csv(df_pov, "data/pmse_ratio_adjusted_pov.csv")
```
...
for(i in 1:n_ratios){
  ...
  pmse_ratio_good <- pmse_ratio(synth_pov_good, data_mi, calc_disc, times, "pov")
  pmse_ratio_pov_med <- pmse_ratio(synth_pov_med, data_mi, calc_disc, times, "pov")
  pmse_ratio_pov_bad <- pmse_ratio(synth_pov_bad, data_mi, calc_disc, times, "pov")
  pmse_ratio_nopov_med <- pmse_ratio(synth_nopov_med, data_mi, calc_disc, times, "pov")
  pmse_ratio_nopov_bad <- pmse_ratio(synth_nopov_bad, data_mi, calc_disc, times, "pov")
  
  pmse_ratios = c(pmse_ratio_nopov_bad, pmse_ratio_nopov_med, pmse_ratio_good, 
                  pmse_ratio_pov_med, pmse_ratio_pov_bad)
