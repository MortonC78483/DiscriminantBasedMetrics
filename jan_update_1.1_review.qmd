...
library(recipes)
library(devtools)
devtools::load_all("/Users/emcfa682/Desktop/Urban/code/syntheval")
library(syntheval)
library(dials)
library(tune)
library(gtools)
...
**EM: This project is really important and interesting! I really liked how you connected your project to real worl issues involving the privacy-utility balance for minority groups. I'm using a discriminant based metric to assess privacy, and I definitely think your work could be helpful with mine.Moreover, I'm sure you've thought about this, but do you think this framework could easily extend to categorical variables? Also, are you doing any hyperparameter tuning to the trees and the lasso regression?**
...
**EM: It makes sense to me that the synthetic data with larger variances made it more difficult for all of the models to parse out whether the data was synthetic or not. I wonder if this trend would hold if the synthetic data had a lower variance.**
